...
/*   Updated: 2021/10/21 13:16:41 by epfennig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef MAP_RBTREE_HPP
# define MAP_RBTREE_HPP
...
namespace ft
{
	...
	class map_rbtree
	{
		...
		public:
				...
				// === CONSTRUCTOR === //
				map_rbtree( void ) : _comp(value_compare()), _alloc(allocator_type()), _root(NULL) {
				...
				map_rbtree(value_compare	comp) : _comp(comp), _alloc(allocator_type()), _root(NULL) {
					NIL = _alloc.allocate(1);
					_alloc.construct(NIL, value_type());
					NIL->color	= BLACK;
					NIL->NIL	= NULL;
				...
				map_rbtree(InputIterator first, InputIterator last, value_compare comp, allocator_type alloc)
		...
		public:
				...
				// === SWAP === //
				void	btree_swap(map_rbtree&	xtree)
				{
